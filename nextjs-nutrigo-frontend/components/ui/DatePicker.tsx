            ...
            >
                ...
                <div className="flex flex-col items-start gap-0.5">
                    ...
                    <span className={`text-xl font-black ${selected ? 'text-[#3d3522]' : 'text-[#8a7550]/40'}`}>
                        {selected ? `${format(selected, 'dd MMMM', { locale: th })} ${selected.getFullYear() + 543}` : placeholder}
                    </span>
                </div>
            </button>
                ...
                >
                    <div className="bg-white rounded-[32px] shadow-[0_15px_50px_-12px_rgba(0,0,0,0.25)] border border-[#f0e6cc] overflow-hidden">
                        ...
                        <div className="px-6 pt-5 pb-1 text-center relative">
                            <h3 className="text-lg font-black text-[#3d3522]">เลือกวันเกิด</h3>
                            <p className="text-[10px] uppercase tracking-wider font-extrabold text-[#8a7550]/40">วัน / เดือน / ปี</p>

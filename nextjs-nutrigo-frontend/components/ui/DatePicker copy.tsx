    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-start gap-0.5">
          ...
          >
            {selected
              ? format(selected, "dd MMMM yyyy", { locale: th })
              : placeholder}
          </span>
        </div>
      </button>
        ...
        >
          ...
          >
            ...
            <div className="px-8 pt-8 pb-4 flex justify-between items-center">
              <div>
                <h3 className="text-2xl font-black text-[#3d3522]">
                  เลือกวันเกิด
                </h3>
                <p className="text-sm font-bold text-[#8a7550]/60">
                  เลื่อนเพื่อเลือก วัน / เดือน / ปี
                </p>
              </div>
              <button
                onClick={() => setIsOpen(false)}

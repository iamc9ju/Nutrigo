...
export default function NutritionistCard({
  ...
  return (
    <div
      className="bg-white rounded-3xl border-2 border-[#f0e6cc] hover:border-[#C6E065] hover:shadow-lg transition-all duration-300 overflow-hidden cursor-pointer group"
      onClick={() =>

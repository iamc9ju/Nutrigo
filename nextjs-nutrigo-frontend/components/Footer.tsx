...
export default function Footer() {
  return (
    <footer className="bg-[#f8fbe8] text-gray-600 py-16 border-t border-[#e0ecb8] relative overflow-hidden">
      <div className="absolute bottom-4 right-6 text-5xl opacity-10 rotate-12 select-none pointer-events-none">
        🥗
      </div>
      <div className="absolute top-6 left-10 text-5xl opacity-10 -rotate-6 select-none pointer-events-none">
        🍏
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">
              เพื่อนคู่คิดด้านสุขภาพของคุณ
              <br />
              เพื่อชีวิตที่ดีอย่างยั่งยืน
            </p>

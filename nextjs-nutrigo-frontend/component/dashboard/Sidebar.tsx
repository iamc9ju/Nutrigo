...
import {
    LayoutGrid, Heart, Calendar, MessageSquare,
    Utensils, BookOpen, ScrollText, BarChart2, LogOut,
    UserCog
} from 'lucide-react';
    ...
    return (
        <aside className="w-64 bg-white h-screen fixed left-0 top-0 border-r border-gray-100 flex flex-col p-6 z-20 shadow-sm">
            ...
            <div className="flex items-center gap-3 mb-10 px-2">
                ...
                {/* ชื่อแบรนด์มักทับศัพท์ แต่ถ้าอยากเปลี่ยนเป็นไทยใช้ "นูทริโก" ได้ครับ */}
                <span className="font-black text-[#3d3522] text-xl tracking-wide">NutriGo</span>
            </div>
            ...
            <nav className="flex-1 space-y-2">
                {menuItems.map((item) => {
                    ...
                    return (
                        ...
                        >
                            <item.icon className={`w-5 h-5 ${isActive ? 'text-[#3d3522]' : 'text-gray-400'}`} />

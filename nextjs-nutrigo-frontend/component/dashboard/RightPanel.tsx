        ...
        <aside className="w-80 bg-white h-screen fixed right-0 top-0 border-l border-gray-100 p-6 overflow-y-auto hidden xl:block">
            ...
            <div className="mb-8">
                ...
                <div className="grid grid-cols-7 gap-1 text-center text-sm font-medium">
                    ...
                    <span className="p-2 bg-[#C6E065] rounded-xl text-[#3d3522] shadow-sm">21</span>
                    ...
                    <div className="p-3 bg-gray-50 rounded-2xl flex gap-3 hover:bg-[#fcfdec] transition-colors group cursor-pointer">
                        ...
                        <div className="flex-1">
                            <div className="flex justify-between items-start">
                                <h5 className="text-xs font-bold text-[#3d3522] group-hover:text-[#4A6707]">Breakfast</h5>
                                <ChevronRight className="w-4 h-4 text-gray-300" />
                            </div>
                            <p className="text-[10px] text-gray-500 line-clamp-1">Fluffy Protein Pancakes</p>
                            <p className="text-[10px] text-orange-500 font-medium mt-1">🔥 380 kcal</p>
                        </div>
                    </div>
                    <div className="p-3 bg-gray-50 rounded-2xl flex gap-3 hover:bg-[#fcfdec] transition-colors group cursor-pointer">
                        <div className="w-12 h-12 bg-white rounded-xl shadow-sm overflow-hidden flex-shrink-0">
                        ...
                        <div className="flex-1">
                            <div className="flex justify-between items-start">
                                <h5 className="text-xs font-bold text-[#3d3522] group-hover:text-[#4A6707]">Lunch</h5>
                                <ChevronRight className="w-4 h-4 text-gray-300" />
                            </div>
                            <p className="text-[10px] text-gray-500 line-clamp-1">Grilled Chicken Salad</p>
                            <p className="text-[10px] text-orange-500 font-medium mt-1">🔥 420 kcal</p>
                        </div>
                    </div>
                </div>
            </div>

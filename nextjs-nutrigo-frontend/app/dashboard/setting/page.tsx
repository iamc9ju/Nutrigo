    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-[#8a7550] mt-1">จัดการข้อมูลส่วนตัวและการแจ้งเตือนของคุณ</p>
            </div>
            ...
            <div className="bg-white rounded-[32px] p-8 shadow-sm border-2 border-[#f0e6cc] min-h-[500px]">
                ...
                {activeTab === 'notifications' ? (
                    <div className="space-y-10">
                        ...
                        <div>
                            ...
                            <div className="space-y-6 divide-y-2 divide-[#f0e6cc]">
                                ...
                                <div className="flex items-center justify-between pt-4 first:pt-0">
                                    <div>
                                        <h3 className="font-bold text-[#3d3522]">เตือนการดื่มน้ำ</h3>
                                        <p className="text-xs text-gray-400">แจ้งเตือนให้ดื่มน้ำทุกๆ 1-2 ชั่วโมง</p>
                                    </div>
                                    <ToggleSwitch
                                ...
                                <div className="flex items-center justify-between pt-6">
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-400">แจ้งเตือนเมื่อใกล้ถึงมื้ออาหาร</p>
                                    </div>
                                    <ToggleSwitch
                                ...
                                <div className="flex items-center justify-between pt-6">
                                    <div>
                                        <h3 className="font-bold text-[#3d3522]">ข่าวสารและอัปเดต</h3>
                                        <p className="text-xs text-gray-400">รับข่าวสารเกี่ยวกับสุขภาพและฟีเจอร์ใหม่ๆ</p>
                                    </div>
                                    <ToggleSwitch
                        ...
                        <div>
                            <h2 className="text-xl font-black text-[#3d3522] mb-6">การตั้งค่าเพิ่มเติม</h2>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-center justify-between">
                                    <h3 className="font-bold text-[#3d3522]">ช่วงเวลาห้ามรบกวน</h3>
                                    <div className="flex items-center gap-3">
                                        <select className="bg-[#faf8f2] border-2 border-[#f0e6cc] text-[#3d3522] text-sm rounded-xl focus:ring-[#C6E065] focus:border-[#C6E065] block p-2.5 outline-none font-medium min-w-[180px]" disabled={!settings.dndMode}>
                                ...
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h3 className="font-bold text-[#3d3522] opacity-80">เปิดใช้งานโหมดห้ามรบกวน</h3>
                                        <p className="text-xs text-gray-400">ปิดเสียงแจ้งเตือนในช่วงเวลาที่กำหนด</p>
                                    </div>
                                    <ToggleSwitch
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex items-center gap-6 pb-8 border-b-2 border-[#f0e6cc]">
                            ...
                            <div>
                                <h2 className="text-2xl font-black text-[#3d3522]">{user?.firstName} {user?.lastName}</h2>
                        ...
                        {/* Personal Info Form (Read-only for now) */}
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-[#3d3522]">ชื่อจริง</label>
                                <div className="px-4 py-3 bg-[#faf8f2] border-2 border-[#f0e6cc] rounded-xl text-[#8a7550] font-medium">
                                    {user?.firstName || '-'}
                                </div>
                            </div>
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-[#3d3522]">นามสกุล</label>
                                <div className="px-4 py-3 bg-[#faf8f2] border-2 border-[#f0e6cc] rounded-xl text-[#8a7550] font-medium">
                                    {user?.lastName || '-'}
                                </div>
                            </div>
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-[#3d3522]">อีเมล</label>
                                <div className="px-4 py-3 bg-[#faf8f2] border-2 border-[#f0e6cc] rounded-xl text-[#8a7550] font-medium">
                                    {user?.email || '-'}
                                </div>
                            </div>
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-[#3d3522]">เบอร์โทรศัพท์</label>
                                <div className="px-4 py-3 bg-[#faf8f2] border-2 border-[#f0e6cc] rounded-xl text-[#8a7550] font-medium">
                                    {profile?.phoneNumber || '-'}
                                </div>
                            </div>
                        ...
                        <div className="bg-[#C6E065]/20 border-2 border-[#C6E065] rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between gap-6">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="font-bold text-[#3d3522] text-lg">ข้อมูลสุขภาพของคุณ</h3>
                                    <p className="text-sm text-[#8a7550]">อัปเดตข้อมูลน้ำหนัก ส่วนสูง และเป้าหมายเพื่อการวิเคราะห์ที่แม่นยำ</p>
                                </div>
                            </div>
                            <Link
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center justify-between">
                            <h2 className="text-xl font-black text-[#3d3522]">ข้อมูลสุขภาพของคุณ</h2>
                            <Link href="/dashboard/complete-profile" className="text-sm font-bold text-[#C6E065] hover:underline flex items-center gap-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div className="bg-[#faf8f2] border-2 border-[#f0e6cc] rounded-2xl p-4 flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-xs text-[#8a7550] font-bold uppercase tracking-wider">น้ำหนัก</p>
                                    <p className="text-xl font-black text-[#3d3522]">
                                        {isLoading ? '...' : (profile?.healthMetrics?.weightKg || '-')} <span className="...">กก.</span>
                                    </p>
                                </div>
                            </div>
                            {/* Height */}
                            <div className="bg-[#faf8f2] border-2 border-[#f0e6cc] rounded-2xl p-4 flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-xs text-[#8a7550] font-bold uppercase tracking-wider">ส่วนสูง</p>
                                    <p className="text-xl font-black text-[#3d3522]">
                                        {isLoading ? '...' : (profile?.healthMetrics?.heightCm || '-')} <span className="...">ซม.</span>
                                    </p>
                                </div>
                            </div>
                            {/* BMI */}
                            <div className="bg-[#faf8f2] border-2 border-[#f0e6cc] rounded-2xl p-4 flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-xs text-[#8a7550] font-bold uppercase tracking-wider">BMI</p>
                                    <p className="text-xl font-black text-[#3d3522]">
                                        {isLoading ? '...' : (
                                            profile?.healthMetrics?.weightKg && profile?.healthMetrics?.heightCm
                                                ? (profile.healthMetrics.weightKg / Math.pow(profile.healthMetrics.heightCm / 100, 2)).toFixed(1)
                                                : '-'
                                        )}
                            ...
                            <div className="bg-[#faf8f2] border-2 border-[#f0e6cc] rounded-2xl p-4 flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-xs text-[#8a7550] font-bold uppercase tracking-wider">% ไขมัน</p>
                                    <p className="text-xl font-black text-[#3d3522]">
                                        {isLoading ? '...' : (profile?.healthMetrics?.bodyFatPercent || '-')} <span className="...">%</span>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="space-y-4">
                            <h3 className="font-bold text-[#3d3522] border-b border-[#f0e6cc] pb-2">ข้อมูลส่วนตัว</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-center justify-between p-4 bg-white border border-[#f0e6cc] rounded-2xl">
                                    ...
                                    {isLoading ? '...' : (
                                        profile?.dateOfBirth
                                            ? new Date(profile.dateOfBirth).toLocaleDateString('th-TH', { year: 'numeric', month: 'long', day: 'numeric' })
                                            : '-'
                                    )}
                                </div>
                                <div className="flex items-center justify-between p-4 bg-white border border-[#f0e6cc] rounded-2xl">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-[#8a7550] font-medium">กรุ๊ปเลือด</span>
                                    </div>
                        ...
                        {/* Health Conditions */}
                        <div className="space-y-4">
                            <h3 className="font-bold text-[#3d3522] border-b border-[#f0e6cc] pb-2">โรคประจำตัว & ภูมิแพ้</h3>
                                ...
                                {isLoading ? (
                                    ...
                                    profile?.chronicDiseases && profile.chronicDiseases.length > 0 ? (
                                        <div className="flex flex-wrap gap-2">
                                            {profile.chronicDiseases.map((disease: string, index: number) => (
                                                <span key={index} className="px-3 py-1.5 bg-white border border-[#f0e6cc] text-[#3d3522] rounded-full text-sm font-bold shadow-sm">
                                                    {disease}
                                                </span>
                                            ))}
                                        </div>
                    ...
                    <div className="space-y-8 max-w-2xl mx-auto">
                        <div className="text-center mb-8">
                            ...
                            <h2 className="text-2xl font-black text-[#3d3522]">เปลี่ยนรหัสผ่าน</h2>
                            <p className="text-[#8a7550] mt-2">เพื่อความปลอดภัย กรุณาตั้งรหัสผ่านที่ยากต่อการคาดเดา</p>
                        </div>

                        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                            {/* Current Password */}
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-[#3d3522]">รหัสผ่านปัจจุบัน</label>
                                <div className="relative">
                                    <input
                                ...
                                <div className="flex justify-end">
                                    <Link href="/forgot-password" className="text-xs font-bold text-[#8a7550] hover:text-[#C6E065] transition-colors">
                                        ลืมรหัสผ่าน?
                                    </Link>
                                </div>
                            </div>
                            ...
                            {/* New Password */}
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-[#3d3522]">รหัสผ่านใหม่</label>
                                <div className="relative">
                                    <input
                            ...
                            {/* Confirm Password */}
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-[#3d3522]">ยืนยันรหัสผ่านใหม่</label>
                                <div className="relative">
                                    <input
                    ...
                    <div className="space-y-8 max-w-2xl mx-auto">
                        <div className="text-center mb-8">
                            ...
                            <h2 className="text-2xl font-black text-[#3d3522]">ตั้งค่าทั่วไป</h2>
                            <p className="text-[#8a7550] mt-2">ปรับแต่งการใช้งานแอปพลิเคชันให้เหมาะกับคุณ</p>
                        </div>

                        {/* Language & Region */}
                        <div className="space-y-4">
                            <h3 className="font-bold text-[#3d3522] border-b border-[#f0e6cc] pb-2">ภาษาและภูมิภาค</h3>
                            <div className="bg-[#faf8f2] border-2 border-[#f0e6cc] rounded-2xl p-4 flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-[#8a7550]">เลือกภาษาที่คุณต้องการใช้งาน</p>
                                    </div>
                                </div>
                        ...
                        {/* Units */}
                        <div className="space-y-4">
                            <h3 className="font-bold text-[#3d3522] border-b border-[#f0e6cc] pb-2">หน่วยวัด</h3>
                            <div className="bg-[#faf8f2] border-2 border-[#f0e6cc] rounded-2xl p-4 flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#3d3522] shadow-sm">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-[#8a7550]">เลือกหน่วยสำหรับน้ำหนักและส่วนสูง</p>
                                    </div>
                                </div>
                                <div className="flex bg-white rounded-lg p-1 border-2 border-[#f0e6cc]">
                                    <button className="px-3 py-1 bg-[#C6E065] text-[#3d3522] text-xs font-bold rounded-md shadow-sm">Metric (kg/cm)</button>
                                    <button className="px-3 py-1 text-[#8a7550] text-xs font-medium hover:text-[#3d3522]">Imperial (lb/ft)</button>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Support & About */}
                        <div className="space-y-4">
                            <h3 className="font-bold text-[#3d3522] border-b border-[#f0e6cc] pb-2">เกี่ยวกับแอปพลิเคชัน</h3>
                            <div className="space-y-3">
                                ...
                                <button className="w-full bg-[#faf8f2] border-2 border-[#f0e6cc] rounded-2xl p-4 flex items-center justify-between hover:bg-white hover:shadow-sm transition-all group">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="text-left">
                                            <p className="font-bold text-[#3d3522]">ข้อกำหนดและเงื่อนไข</p>
                                        </div>
                                    </div>
                                    <ChevronRight className="w-5 h-5 text-[#8a7550]" />
                                </button>
                                <button className="w-full bg-[#faf8f2] border-2 border-[#f0e6cc] rounded-2xl p-4 flex items-center justify-between hover:bg-white hover:shadow-sm transition-all group">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="text-left">
                                            <p className="font-bold text-[#3d3522]">นโยบายความเป็นส่วนตัว</p>
                                        </div>
                                    </div>
                                    <ChevronRight className="w-5 h-5 text-[#8a7550]" />
                                </button>
                        ...
                        <div className="text-center pt-8 pb-4">
                            <p className="text-xs text-gray-400 font-medium">NutriGo Version 1.0.0 (Build 20240215)</p>
                        </div>
                    </div>
                ) : (
                    ...
                    <div className="space-y-8 max-w-2xl mx-auto">
                        ...
                        <div className="text-center mb-12">
                            ...
                            <h2 className="text-3xl font-black text-[#3d3522] mb-2 tracking-tight">NutriGo</h2>
                            <p className="text-[#8a7550] font-medium">เพื่อนคู่คิดสุขภาพของคุณ</p>
                            <div className="mt-4 inline-block px-4 py-1.5 bg-[#f0e6cc] rounded-full">
                                <p className="text-xs font-bold text-[#3d3522] tracking-wide">VERSION 1.0.0</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-[#faf8f2] border-2 border-[#f0e6cc] rounded-2xl p-6 text-center relative overflow-hidden">
                            ...
                            <h3 className="font-bold text-[#3d3522] mb-3 relative z-10">ภารกิจของเรา</h3>
                            <p className="text-[#8a7550] leading-relaxed relative z-10">
                                "เรามุ่งมั่นที่จะช่วยให้ทุกคนมีสุขภาพที่ดีขึ้น ผ่านการแนะนำโภชนาการที่เข้าใจง่าย และสามารถนำไปปรับใช้ได้จริงในชีวิตประจำวัน เพื่อสร้างสังคมสุขภาพดีที่ยั่งยืน"
                            </p>
                        </div>

                        {/* Contact Info */}
                        <div className="space-y-4">
                            <h3 className="font-bold text-[#3d3522] border-b border-[#f0e6cc] pb-2">ติดต่อเรา</h3>
                            <div className="grid grid-cols-1 gap-4">
                                <div className="flex items-center gap-4 bg-white border border-[#f0e6cc] p-4 rounded-xl hover:shadow-sm transition-shadow">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-[#3d3522] font-medium">123 อาคารสาทรซิตี้ทาวเวอร์ เขตสาทร กรุงเทพฯ 10120</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4 bg-white border border-[#f0e6cc] p-4 rounded-xl hover:shadow-sm transition-shadow">
                                    <div className="w-10 h-10 bg-[#faf8f2] rounded-full flex items-center justify-center text-[#3d3522]">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-[#3d3522] font-medium">support@nutrigo.com</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4 bg-white border border-[#f0e6cc] p-4 rounded-xl hover:shadow-sm transition-shadow">
                                    <div className="w-10 h-10 bg-[#faf8f2] rounded-full flex items-center justify-center text-[#3d3522]">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-[#3d3522] font-medium">02-123-4567</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="text-center pt-8 border-t border-[#f0e6cc]">
                            <p className="text-xs text-gray-400">© 2024 NutriGo Co., Ltd. All rights reserved.</p>
                        </div>
                    </div>
                )}
            </div>
